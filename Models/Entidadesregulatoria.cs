...
{
    public partial class Entidadesregulatoria
    {
        public long Identidadregulatoria { get; set; }
        ...
        public virtual Participante IdentidadregulatoriaNavigation { get; set; } = null!;
    }
}
